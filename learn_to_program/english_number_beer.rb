...
beer = 9999
while beer != 0
  if beer > 1 # for pluralization
    puts "#{englishNumber(beer).capitalize} bottles of beer on the wall, #{englishNumber(beer)} bottles of beer."
  else
    puts "#{englishNumber(beer).capitalize} bottle of beer on the wall, #{englishNumber(beer)} bottles of beer."
  end
  beer -= 1
  puts "Take one down and pass it around, #{englishNumber(beer)} bottles of beer on the wall."
end